...
export class MovieService {
  ...
  private _allMovies = [
    ...
    },
    {
      ...
      "poster": "https://m.media-amazon.com/images/M/MV5BYjJkZGVjMDMtMzNmZS00NDQ3LWE1YWEtMDlmYjExMTA4MGFkXkEyXkFqcGdeQXVyODY0NzcxNw@@._V1_SY1000_CR0,0,662,1000_AL_.jpg"
    },
    {
      "title": "The Shining",
      "year": "1980",
  ...
  constructor() {
    this.configMovieObject()
   }

  private configMovieObject(){
    this._allMovies.map(movie =>{
